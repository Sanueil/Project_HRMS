...
<body>
            ...
            <table class="table table-striped mt-3">
                ...
                while ($account = $result->fetch_assoc()) {
                    ...
                    if ($account['id_phan_quyen'] !== '1') {
                        ...
                        echo "<td><button type='button' onclick=\"openPasswordModal(" . $account['username'] . ")\" class='btn btn-primary btn-sm'>Sửa</button>
                        <button type='button' onclick=\"window.location.href='delete.php?id=" . $account['id'] . "'\" class='btn btn-danger btn-sm'>Xóa</button></td>";
                        echo "</tr>";
                    }
                }
                ?>
    ...
    <div id="changePasswordModal" class="modal">
        <div class="modal-content">
            ...
            <form id="passwordForm" method="POST" action="../controller/new_pass.php">
